<?php
	...
	public function test()
	{
        ...
        public function keeptemplate()
        {
            ...
            if(file_put_contents(C("ROOT")."/mailtemplate.json",$Jsoncontent)>0)
            {
                json_return([
                    "errcode"=>0,
                    "msg"=>"邮件模板修改成功",
            ...
            else
            {
                json_return([
                    "errcode"=>1,
                    "msg"=>"邮件模板修改失败，请检查你是否具有目录".C("ROOT")."/mailtemplate.json",
                ]);
            }
        }
        //邮件发送代码(订阅成功)
        ...
        {
            $content = json_decode(file_get_contents(C("ROOT")."/mailtemplate.json"));
