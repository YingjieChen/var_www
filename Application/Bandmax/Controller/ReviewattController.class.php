<?php
    ...
    class ReviewattController extends Controller {
        ...
        public function submitreview()
        {
		    ...
		    if(!file_exists($upload->rootPath.$file['savepath'])) mkdir($upload->rootPath.$file['savepath']);
                    $files[] = $file['savepath'].$file['savename'];
                    $image = new \Think\Image(Image::IMAGE_GD,$upload->rootPath.$file['savepath'].$file['savename']); // GD库
...
//            }
            ...
            $rating         =       $review["rating"]?intval($review["rating"]):1;
