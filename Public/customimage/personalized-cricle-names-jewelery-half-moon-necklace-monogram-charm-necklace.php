<?php
	...
	$textcontent1_1	=	mb_substr($textcontent,0,25,'utf-8');
	$textcontent1_2 =       mb_substr($textcontent,25,20,'utf-8');
	$textcontent1_3 =       mb_substr($textcontent,45,18,'utf-8');
	$textcontent1_4 =       mb_substr($textcontent,63,10,'utf-8');
	$textcontent	=	"$textcontent1_1\n   $textcontent1_2  \n     $textcontent1_3     \n        $textcontent1_4     ";
	...
	$textcontent2_1 =       mb_substr($textcontent2,0,25,'utf-8');
        $textcontent2_2 =       mb_substr($textcontent2,25,20,'utf-8');
        $textcontent2_3 =       mb_substr($textcontent2,45,18,'utf-8');
        $textcontent2_4 =       mb_substr($textcontent2,63,12,'utf-8');
	$textcontent2   =       "$textcontent2_1\n   $textcontent2_2  \n     $textcontent2_3     \n        $textcontent2_4     ";
