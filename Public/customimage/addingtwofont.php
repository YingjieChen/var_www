<?php
	...
	$left           =       isset($_GET['left'])?intval($_GET['left'])-($fontSize*mb_strlen($textcontent,'utf-8')/3):150;      //左边距
	...
	$left2           =       isset($_GET['left2'])?intval($_GET['left2'])-($fontSize2*mb_strlen($textcontent2,'utf-8')/3):150;      //左边距
